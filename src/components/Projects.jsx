...
import analytics from '../assets/RedditAnalytics.png';
...
const projData = [
    {
    id: 1,
    title: 'Reddit/Twitter Sentiment/Hate-speech Detection Dashboard',
    category: 'Full-Stack Applications',
    featured: true,
    image: analytics,
    period: 'Jul 2025',
    stack: ['Pytorch', 'Scikit-learn', 'Next.js', 'Reddit API', 'Twitter API v2'],
    sourceLink: 'https://github.com/ed-ward-huang/reddit-social-media-analyzer',
    demoLink: '',
    details: [
      'Developed an analytics dashboard that aggregates content and replies from Twitter and Reddit of a given subreddit, providing insights into user engagment, sentiment analysis of comments and replies',
      'Integrated four NLP models for sentiment, hate detection, toxicity scoring, and categorization',
      'Real-time frontend streams results with interactive visualizations; flagged content linked to original posts',
      'Tested on 20 subreddits & 8,000+ comments; expanding to Twitter and Discord.',
      'Project inspired by interest in online hate & toxicity, tackling real-world social challenges',
    ],
  },
  {
    id: 5,
